...
describe TreatmentsController do
  ...
  describe "GET index" do
    it "assigns all treatments as @treatments" do
      ...
      assigns(:treatments).should eq([treatment])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested treatment as @treatment" do
      ...
      assigns(:treatment).should eq(treatment)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new treatment as @treatment" do
      ...
      assigns(:treatment).should be_a_new(Treatment)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created treatment as @treatment" do
        post :create, {:treatment => valid_attributes}, valid_session
        assigns(:treatment).should be_a(Treatment)
        assigns(:treatment).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved treatment as @treatment" do
        ...
        Treatment.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested treatment" do
        ...
        Treatment.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
      ...
      it "redirects to the treatment index page" do
        treatment = Treatment.create! valid_attributes
        put :update, {:id => treatment.to_param, :treatment => valid_attributes}, valid_session
        response.should redirect_to(treatments_path)
      end
    end
