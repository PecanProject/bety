...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (config.isHtmlGenerationEnabled()) {
                ...
                ResourceWriter.getInstance().writeResource("/schemaSpy.js", new File(outputDir, "/schemaSpy.js"));
                 ResourceWriter.getInstance().writeResource("/base.css", new File(outputDir, "/base.css"));
                 ResourceWriter.getInstance().writeResource("/tables.css", new File(outputDir, "/tables.css"));
                 ResourceWriter.getInstance().writeResource("/grid.css", new File(outputDir, "/grid.css"));
