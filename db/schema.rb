...
ActiveRecord::Schema.define(:version => 20131004141248) do
  ...
  create_table "mgmtview", :id => false, :force => true do |t|
    t.integer "yield_id", :limit => 8, :null => false
    t.date    "planting"
    t.date    "seeding"
    t.date    "coppice"
  end
  ...
  create_table "traits_and_yields_view", :id => false, :force => true do |t|
    t.string  "result_type",       :limit => 6,                                :default => "", :null => false
